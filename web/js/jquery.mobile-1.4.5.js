...
!function (a, b, c) {
    ...
    !function (a) {
        ...
        a.widget("mobile.loader", {
            options: {theme: "a", textVisible: !1, html: "", text: ""},
        ...
        a.widget("mobile.button", {
            ...
            refresh: function (b) {
                ...
                this.options.icon && "notext" === this.options.iconpos && this.element.attr("title") && this.element.attr("title", this.element.val()), b || (c = this.element.detach(), a(this.wrapper).text(this.element.val())), this.options.disabled !== d && this._setOptions({disabled: d})
            }
        })
    }(a), function (a) {
